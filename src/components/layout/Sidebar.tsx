...
export const Sidebar: React.FC = () => {
    return (
        <aside className="w-64 bg-midnight flex flex-col h-full shrink-0 border-r border-white/5 shadow-2xl relative z-50">
            <div className="p-8 flex items-center gap-4">
                ...
                <div>
                    <h1 className="font-display font-black text-white text-xl tracking-tighter leading-none">Sprinto</h1>
                    <span className="text-[9px] font-extrabold text-white/30 uppercase tracking-[0.2em] mt-1 block">Enterprise</span>
                </div>
            </div>
            ...
            <div className="p-6 mt-auto">
                <div className="bg-canvas-white/[0.03] rounded-3xl p-6 border border-white/[0.05] relative overflow-hidden group hover:border-primary/30 transition-all">
                    ...
                    <p className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-4">Workspace Health</p>
                    <div className="flex items-center gap-4">
                        <div className="relative w-12 h-12 flex items-center justify-center">
                            ...
                            <span className="absolute text-[10px] font-black text-white">82%</span>
                        </div>
                        <div className="flex-1">
                            <p className="text-[10px] font-black text-white tracking-tight">Prime Status</p>
